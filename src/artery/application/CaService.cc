...
vanetza::asn1::Cam createCooperativeAwarenessMessage(const VehicleDataProvider& vdp, uint16_t genDeltaTime)
{
	...
	bvc.heading.headingValue = Constants::round(vdp.heading(), Constants::decidegree);
	...
	bvc.yawRate.yawRateValue = Constants::round(vdp.yaw_rate(), Constants::degree_per_second) * YawRateValue_degSec_000_01ToLeft * 100.0;
